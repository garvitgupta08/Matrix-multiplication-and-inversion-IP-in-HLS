...
`define AUTOTB_TVIN_A_0  "./c.matrixmult.autotvin_A_0.dat"
`define AUTOTB_TVIN_A_1  "./c.matrixmult.autotvin_A_1.dat"
`define AUTOTB_TVIN_B_0  "./c.matrixmult.autotvin_B_0.dat"
`define AUTOTB_TVIN_B_1  "./c.matrixmult.autotvin_B_1.dat"
`define AUTOTB_TVIN_res  "./c.matrixmult.autotvin_res.dat"
`define AUTOTB_TVIN_A_0_out_wrapc  "./rtl.matrixmult.autotvin_A_0.dat"
`define AUTOTB_TVIN_A_1_out_wrapc  "./rtl.matrixmult.autotvin_A_1.dat"
`define AUTOTB_TVIN_B_0_out_wrapc  "./rtl.matrixmult.autotvin_B_0.dat"
`define AUTOTB_TVIN_B_1_out_wrapc  "./rtl.matrixmult.autotvin_B_1.dat"
`define AUTOTB_TVIN_res_out_wrapc  "./rtl.matrixmult.autotvin_res.dat"
`define AUTOTB_TVOUT_res  "./c.matrixmult.autotvout_res.dat"
`define AUTOTB_TVOUT_res_out_wrapc  "./impl_rtl.matrixmult.autotvout_res.dat"
module `AUTOTB_TOP;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.matrixmult.autotvout_res.dat", "r");
    fp2 = $fopen("./impl_rtl.matrixmult.autotvout_res.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.matrixmult.autotvout_res.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.matrixmult.autotvout_res.dat\"!");
    else begin
        $display("Comparing rtl.matrixmult.autotvout_res.dat with impl_rtl.matrixmult.autotvout_res.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
