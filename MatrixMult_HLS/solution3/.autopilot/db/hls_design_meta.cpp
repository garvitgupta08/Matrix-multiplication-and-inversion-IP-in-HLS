...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("A_0_address1", 3, hls_out, 0, "ap_memory", "MemPortADDR2", 1),
	...
	Port_Property("res_d0", 32, hls_out, 4, "ap_memory", "mem_din", 1),
};
