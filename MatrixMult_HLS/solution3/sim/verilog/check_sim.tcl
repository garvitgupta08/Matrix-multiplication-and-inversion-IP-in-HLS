...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.matrixmult.autotvin_A_0.dat"
         "c.matrixmult.autotvin_A_1.dat"
         "c.matrixmult.autotvin_B_0.dat"
         "c.matrixmult.autotvin_B_1.dat"
         "c.matrixmult.autotvin_res.dat"
         "c.matrixmult.autotvout_res.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.matrixmult.autotvout_res.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
