...
if {[file isfile matrixmult.autotvin.dat]} {
	file delete -force matrixmult.autotvin.dat
}

if {[file isfile matrixmult.autotvout.dat]} {
	file delete -force matrixmult.autotvout.dat
}
