...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "matrixmult.autotvin.dat"
	set constFileTvOut       "matrixmult.autotvout.dat"
	set constFileHdlTvIn     "matrixmult.autohdltvin.dat"
	set constFileHdlTvOut    "matrixmult.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
