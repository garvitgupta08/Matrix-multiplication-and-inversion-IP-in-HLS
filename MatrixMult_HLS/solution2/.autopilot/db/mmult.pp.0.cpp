# 1 "MatrixMult_HLS/mmult.cpp"
# 1 "MatrixMult_HLS/mmult.cpp" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 152 "<built-in>" 3
# 1 "<command line>" 1
...
# 9 "<command line>" 2
# 1 "<built-in>" 2
# 1 "MatrixMult_HLS/mmult.cpp" 2
# 1 "MatrixMult_HLS/mmult.h" 1
...
# 3 "MatrixMult_HLS/mmult.h" 2


typedef float T;

void matrixmult(T A[4][4],T B[4][4],T res[4][4]);
# 2 "MatrixMult_HLS/mmult.cpp" 2

void matrixmult(T A[4][4],T B[4][4],T res[4][4])
{_ssdm_SpecArrayDimSize(A, 4);_ssdm_SpecArrayDimSize(B, 4);_ssdm_SpecArrayDimSize(res, 4);
 for(int i=0;i<4;i++){
