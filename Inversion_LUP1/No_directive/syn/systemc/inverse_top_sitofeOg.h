...
// ==============================================================
#ifndef __inverse_top_sitofeOg__HH__
#define __inverse_top_sitofeOg__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(inverse_top_sitofeOg) {
    ...
    SC_CTOR(inverse_top_sitofeOg):  ACMP_sitofp_U ("ACMP_sitofp_U") {
