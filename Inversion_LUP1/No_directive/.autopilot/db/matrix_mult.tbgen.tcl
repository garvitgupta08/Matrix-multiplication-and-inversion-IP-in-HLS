...
set C_modelArgList {
	{ U_inv float 32 regular {array 9 { 1 3 } 1 1 }  }
	{ L_inv float 32 regular {array 9 { 1 3 } 1 1 }  }
	{ A_inv float 32 regular {array 9 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "U_inv", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ U_inv_address0 sc_out sc_lv 4 signal 0 } 
	{ U_inv_ce0 sc_out sc_logic 1 signal 0 } 
	{ U_inv_q0 sc_in sc_lv 32 signal 0 } 
	{ L_inv_address0 sc_out sc_lv 4 signal 1 } 
	{ L_inv_ce0 sc_out sc_logic 1 signal 1 } 
	{ L_inv_q0 sc_in sc_lv 32 signal 1 } 
	{ A_inv_address0 sc_out sc_lv 4 signal 2 } 
	{ A_inv_ce0 sc_out sc_logic 1 signal 2 } 
	{ A_inv_we0 sc_out sc_logic 1 signal 2 } 
	{ A_inv_d0 sc_out sc_lv 32 signal 2 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.inverse_top_fadd_hbi_U30", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.inverse_top_fmul_cud_U31", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	U_inv { ap_memory {  { U_inv_address0 mem_address 1 4 }  { U_inv_ce0 mem_ce 1 1 }  { U_inv_q0 mem_dout 0 32 } } }
	L_inv { ap_memory {  { L_inv_address0 mem_address 1 4 }  { L_inv_ce0 mem_ce 1 1 }  { L_inv_q0 mem_dout 0 32 } } }
