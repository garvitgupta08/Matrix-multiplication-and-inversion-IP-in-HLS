...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename U \
    op interface \
    ports { U_address0 { O 4 vector } U_ce0 { O 1 bit } U_we0 { O 1 bit } U_d0 { O 32 vector } } \
} "
} else {
