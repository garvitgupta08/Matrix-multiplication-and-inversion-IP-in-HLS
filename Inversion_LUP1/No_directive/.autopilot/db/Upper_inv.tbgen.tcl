...
set C_modelArgList {
	...
	{ U_inv float 32 regular {array 9 { 2 3 } 1 1 }  }
}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.inverse_top_fadd_hbi_U25", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.inverse_top_fmul_cud_U26", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.inverse_top_fdiv_dEe_U27", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "159", "Max" : "363"}
	, {"Name" : "Interval", "Min" : "159", "Max" : "363"}
]}
...
set Spec2ImplPortList { 
	...
	U_inv { ap_memory {  { U_inv_address0 mem_address 1 4 }  { U_inv_ce0 mem_ce 1 1 }  { U_inv_we0 mem_we 1 1 }  { U_inv_d0 mem_din 1 32 }  { U_inv_q0 mem_dout 0 32 } } }
}
