...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("A_inv_address0", 4, hls_out, 1, "ap_memory", "mem_address", 1),
	Port_Property("A_inv_ce0", 1, hls_out, 1, "ap_memory", "mem_ce", 1),
	Port_Property("A_inv_we0", 1, hls_out, 1, "ap_memory", "mem_we", 1),
	Port_Property("A_inv_d0", 32, hls_out, 1, "ap_memory", "mem_din", 1),
	Port_Property("ap_return", 1, hls_out, -1, "", "", 1),
};
const char* HLS_Design_Meta::dut_name = "inverse_top";
