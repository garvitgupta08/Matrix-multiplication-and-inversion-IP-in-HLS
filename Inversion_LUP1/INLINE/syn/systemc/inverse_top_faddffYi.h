...
// ==============================================================
#ifndef __inverse_top_faddffYi__HH__
#define __inverse_top_faddffYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(inverse_top_faddffYi) {
    ...
    SC_CTOR(inverse_top_faddffYi):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
