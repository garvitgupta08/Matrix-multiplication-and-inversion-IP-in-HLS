...
// ==============================================================
#ifndef __inverse_top_fcmp_hbi__HH__
#define __inverse_top_fcmp_hbi__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(inverse_top_fcmp_hbi) {
    ...
    SC_CTOR(inverse_top_fcmp_hbi):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
