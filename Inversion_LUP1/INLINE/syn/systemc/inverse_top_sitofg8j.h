...
// ==============================================================
#ifndef __inverse_top_sitofg8j__HH__
#define __inverse_top_sitofg8j__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(inverse_top_sitofg8j) {
    ...
    SC_CTOR(inverse_top_sitofg8j):  ACMP_sitofp_U ("ACMP_sitofp_U") {
