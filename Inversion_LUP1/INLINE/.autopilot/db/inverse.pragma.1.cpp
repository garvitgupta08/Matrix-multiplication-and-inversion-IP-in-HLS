# 1 "Inversion_LUP1/inverse.cpp"
# 1 "Inversion_LUP1/inverse.cpp" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 152 "<built-in>" 3
# 1 "<command line>" 1
...
# 9 "<command line>" 2
# 1 "<built-in>" 2
# 1 "Inversion_LUP1/inverse.cpp" 2
...
# 624 "D:/Xilinx/Vivado/2019.1/win64/tools/clang/bin/../lib/clang/3.1/../../../x86_64-w64-mingw32/include\\stdlib.h" 3
}
...
# 202 "D:/Xilinx/Vivado/2019.1/win64/tools/clang/bin/../lib/clang/3.1/../../../x86_64-w64-mingw32/include\\malloc.h" 3
}


#pragma pack(pop)
# 630 "D:/Xilinx/Vivado/2019.1/win64/tools/clang/bin/../lib/clang/3.1/../../../x86_64-w64-mingw32/include\\stdlib.h" 2 3
# 3 "Inversion_LUP1/inverse.cpp" 2
...
# 4 "Inversion_LUP1/inverse.cpp" 2
# 1 "D:/Xilinx/Vivado/2019.1/win64/tools/clang/bin/../lib/clang/3.1/include\\stdbool.h" 1 3 4
# 5 "Inversion_LUP1/inverse.cpp" 2
# 1 "Inversion_LUP1/inverse.h" 1





bool lup(float A[3][3], float L[3][3], float U[3][3], float P[3 +1]);
void Lower_inv (float L[3][3], float L_inv[3][3]);
void Upper_inv (float U[3][3], float U_inv[3][3]);
void matrix_mult (float U_inv[3][3], float L_inv[3][3], float A_inv[3][3]);
void final_perm(float UL_inv[3][3], float P[3 +1], float A_inv[3][3]);
bool inverse_top(float A[3][3], float A_inv[3][3]);
# 6 "Inversion_LUP1/inverse.cpp" 2

bool lup(float A[3][3], float L[3][3], float U[3][3], float P[3 +1])
{_ssdm_SpecArrayDimSize(A, 3);_ssdm_SpecArrayDimSize(L, 3);_ssdm_SpecArrayDimSize(U, 3);_ssdm_SpecArrayDimSize(P, 4);
_ssdm_InlineSelf(0, "");
 ...
 PermutMat_Initialize: for(int i = 0 ; i < 3 ; i++)
 {
_ssdm_op_SpecPipeline(-1, 1, 1, 0, "");
 ...
 int i, j, k ;
 bool singular = 0 ;
# 36 "Inversion_LUP1/inverse.cpp"
 lup_label0: for(i = 0 ; i < 3 ; i++)
 {
_ssdm_op_SpecPipeline(-1, 1, 1, 0, "");
...
_ssdm_op_SpecLoopTripCount(1, 3, 2, "");
 float tmp = A[k][i];
  ...
  lup_label1: for(k = i+1; k < 3; k++)
  {
_ssdm_op_SpecLoopTripCount(1, 3, 2, "");
 A[k][i] = A[k][i]/A[i][i];
   lup_label2: for(j = i+1 ; j < 3 ; j++)
   {
_ssdm_op_SpecPipeline(-1, 1, 1, 0, "");
_ssdm_op_SpecLoopTripCount(1, 3, 2, "");
 ...
 Assign_L0: for(int i = 0 ; i < 3 ; i++)
 {
  Assign_L1: for(int j = i ; j < 3 ; j++)
  {
_ssdm_op_SpecPipeline(-1, 1, 1, 0, "");
_ssdm_op_SpecLoopTripCount(1, 3, 2, "");
 if(i == j)
 ...
 Assign_U0: for(int i = 0 ; i < 3 ; i++)
 {
  Assign_U1: for(int j = i ; j < 3 ; j++)
  {
_ssdm_op_SpecPipeline(-1, 1, 1, 0, "");
_ssdm_op_SpecLoopTripCount(1, 3, 2, "");
 U[i][j] = A[i][j];
...
void Lower_inv (float L[3][3], float L_inv[3][3])
{_ssdm_SpecArrayDimSize(L, 3);_ssdm_SpecArrayDimSize(L_inv, 3);
# 147 "Inversion_LUP1/inverse.cpp"
 linv_label0: for(int i = 0 ; i < 3 ; i++)
 {
  linv_label1: for(int j = 0 ; j < 3 ; j++)
  {
...
void Upper_inv (float U[3][3], float U_inv[3][3])
{_ssdm_SpecArrayDimSize(U, 3);_ssdm_SpecArrayDimSize(U_inv, 3);
 ...
 uinv_label10: for(int i = 0 ; i < 3 ; i++)
 {
_ssdm_op_SpecPipeline(-1, 1, 1, 0, "");
 uinv_label11: for(int j = 0 ; j < 3 ; j++)
  {
   U_inv[i][j] = 0;
  }
 }

 uinv_label20: for(int i = 0 ; i < 3 ; i++)
 {
_ssdm_op_SpecPipeline(-1, 1, 1, 0, "");
 U_inv[i][i] = (float) 1/U[i][i];
 }

 univ_label30: for (int i = 0 ; i < 3 ; i++)
 {
...
void matrix_mult (float U_inv[3][3], float L_inv[3][3], float A_inv[3][3])
{_ssdm_SpecArrayDimSize(U_inv, 3);_ssdm_SpecArrayDimSize(L_inv, 3);_ssdm_SpecArrayDimSize(A_inv, 3);
_ssdm_SpecArrayPartition( L_inv, 1, "BLOCK", 3, "");
_ssdm_InlineSelf(0, "");
 float sumTemp = 0;
 MM_L1: for (int i = 0 ; i < 3 ; i++)
 {
  MM_L2: for (int j = 0 ; j < 3 ; j++)
  {
_ssdm_op_SpecPipeline(-1, 1, 1, 0, "");
 float sumFinal = 0 ;
   MM_L3: for (int k = 0 ; k < 3 ; k++)
   {
...
void final_perm(float UL_inv[3][3], float P[3 +1], float A_inv[3][3])
{_ssdm_SpecArrayDimSize(UL_inv, 3);_ssdm_SpecArrayDimSize(P, 4);_ssdm_SpecArrayDimSize(A_inv, 3);
_ssdm_InlineSelf(0, "");
...
bool inverse_top(float A[3][3], float A_inv[3][3])
{_ssdm_SpecArrayDimSize(A, 3);_ssdm_SpecArrayDimSize(A_inv, 3);
 float L [3][3], U [3][3];
 float L_inv [3][3], U_inv [3][3],UL_inv[3][3];
 float P[3 +1];
...
# 318 "Inversion_LUP1/inverse.cpp"
 }
